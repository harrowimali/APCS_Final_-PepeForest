...
extern "C"
{
    ...
    const char*         UnityIPhoneRuntimeVersion = "5.3.4f1";
...
#define DLL_EXPORT
    ...
    DECL_USER_FUNC(SetListenerGain);
    DECL_USER_FUNC(SetListenerTransform);
    DECL_USER_FUNC(CreateSource);
    DECL_USER_FUNC(DestroySource);
    DECL_USER_FUNC(SetSourceBypassRoomEffects);
    DECL_USER_FUNC(SetSourceDirectivity);
    DECL_USER_FUNC(SetSourceDistanceAttenuationMethod);
    DECL_USER_FUNC(SetSourceGain);
    DECL_USER_FUNC(SetSourceOcclusionIntensity);
    DECL_USER_FUNC(SetSourceSpread);
    DECL_USER_FUNC(SetSourceTransform);
    DECL_USER_FUNC(CreateRoom);
    DECL_USER_FUNC(DestroyRoom);
    DECL_USER_FUNC(SetRoomProperties);
    DECL_USER_FUNC(Initialize);
    DECL_USER_FUNC(Shutdown);
    ...
    DECL_USER_FUNC(setUILayerEnabled);
...
DLL_EXPORT void RegisterMonoModules()
{
    ...
    REGISTER_USER_FUNC(SetListenerGain);
    REGISTER_USER_FUNC(SetListenerTransform);
    REGISTER_USER_FUNC(CreateSource);
    REGISTER_USER_FUNC(DestroySource);
    REGISTER_USER_FUNC(SetSourceBypassRoomEffects);
    REGISTER_USER_FUNC(SetSourceDirectivity);
    REGISTER_USER_FUNC(SetSourceDistanceAttenuationMethod);
    REGISTER_USER_FUNC(SetSourceGain);
    REGISTER_USER_FUNC(SetSourceOcclusionIntensity);
    REGISTER_USER_FUNC(SetSourceSpread);
    REGISTER_USER_FUNC(SetSourceTransform);
    REGISTER_USER_FUNC(CreateRoom);
    REGISTER_USER_FUNC(DestroyRoom);
    REGISTER_USER_FUNC(SetRoomProperties);
    REGISTER_USER_FUNC(Initialize);
    REGISTER_USER_FUNC(Shutdown);
    ...
    REGISTER_USER_FUNC(GetEventFlags);
    ...
    REGISTER_USER_FUNC(setUILayerEnabled);
...
void RegisterAllStrippedInternalCalls ()
{
	...
	void Register_UnityEngine_ParticleSystem_SizeOverLifetimeModule_SetSize ();
	Register_UnityEngine_ParticleSystem_SizeOverLifetimeModule_SetSize ();
	void Register_UnityEngine_ParticleSystem_SizeOverLifetimeModule_GetSize ();
	Register_UnityEngine_ParticleSystem_SizeOverLifetimeModule_GetSize ();
	...
	void Register_UnityEngine_ParticleSystem_SizeBySpeedModule_SetSize ();
	Register_UnityEngine_ParticleSystem_SizeBySpeedModule_SetSize ();
	void Register_UnityEngine_ParticleSystem_SizeBySpeedModule_GetSize ();
	Register_UnityEngine_ParticleSystem_SizeBySpeedModule_GetSize ();
